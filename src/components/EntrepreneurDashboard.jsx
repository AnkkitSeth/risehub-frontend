// src/components/EntrepreneurDashboard.jsx
...
function EntrepreneurDashboard() {
  ...
  return (
    <DashboardWrapper>
      <Sidebar>
        <SidebarTitle>Entrepreneur</SidebarTitle>
        <NavLink to="/profile" active={location.pathname === '/profile' ? 1 : 0}><FiUser /> Profile</NavLink>
        <NavLink to="/my-startups" active={location.pathname === '/my-startups' ? 1 : 0}><FiBriefcase /> My Startups</NavLink>
      ...
      <Content>
        <HeadingCard>
          ...
          <SubText>Manage your startups, connect with investors, and track your growth — all in one place.</SubText>
        </HeadingCard>
      </Content>
    </DashboardWrapper>
  );
